#!/usr/bin/env bash
#  Copyright (c) 2024 Greg Rynkowski (https://rynkowski.pl)
#  License: MIT License
...
# Library Sourcing
SHELL_GR_DIR="${SHELL_GR_DIR:-"${ROOT_DIR}/.github_deps/rynkowsg/shell-gr@v0.5.0"}"
# shellcheck source=.github_deps/rynkowsg/shell-gr@v0.5.0/lib/tool/format.bash
